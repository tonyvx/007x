...
####Data Challenges
  ...
  Impact of market trends are not considered in the data
  
  Salary is factored into high, medium & low

### Data Insights

####_Total Employees : `r NROW(hr)`_

####_Total Employees leaving : `r NROW(hr %>% filter(left==1))`_

#####_Observation - For employees that are performing with high evaluation rating:_
Low overall statisfaction, high workload (projects, monthly hours, work accident) & less incentive (promotion) are seen as reasons for leaving
