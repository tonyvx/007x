...
conf_matrix$table
```
* Specificity is low - Proportion of folks leaving due to accident is lower `r conf_matrix$byClass["Specificity"]`
* Sensitivity is high - Indicates large proportion of accident continue to stay `r conf_matrix$byClass["Sensitivity"]`
...
* Specificity is low - Proportion of folks leaving is low among folks with promotion `r conf_matrix$byClass["Specificity"]`

* Sensitivity is high - Indicates high percent of employees who did not get promoted yet continued to stay `r conf_matrix$byClass["Sensitivity"]`
