...
#### Of `r total_emp_remaining` employees that remain 
* `r total_emp_stayed_beyond_pred_tm_spent` have stayed beyond prediction
* `r (total_emp_remaining-total_emp_stayed_beyond_pred_tm_spent)` have not reached predicted time_spend_before_leaving 
