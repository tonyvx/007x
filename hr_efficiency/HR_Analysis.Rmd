...
####Logistics regression model to predict employees leaving the company is predicting with an 
  * overall Accuracy of `r glm_confustion_matrix_validation$overall["Accuracy"]`,
  * predicting employees leaving company with `r glm_confustion_matrix_validation$byClass["Specificity"]` accuracy and
  * predicting employess staying with the company with `r glm_confustion_matrix_validation$byClass["Sensitivity"]` accuracy.
...
####Random forest regression model to predict employees leaving the company is predicting with an 
  * overall Accuracy of `r rf_confustion_matrix_validation$overall["Accuracy"]`,
  * predicting employees leaving company with `r rf_confustion_matrix_validation$byClass["Specificity"]` accuracy and 
  * predicting employess staying with the company with `r rf_confustion_matrix_validation$byClass["Sensitivity"]` accuracy.
