...
#Lets verify everwrk,age_p & r_maritl
...
#Never married and widowed groups have higher probability of ever worked, than other groups 
#since other groups may have more often housewife's and once on alimony support
